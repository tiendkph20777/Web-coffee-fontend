...
const ProductDetail = (props: any) => {
    ...
    const otherProducts = props.products.filter(((item: any) => item.id != id)).slice(startIndex, endIndex)
    const totalProducts = props.products.filter(((item: any) => item.id != id)).length
